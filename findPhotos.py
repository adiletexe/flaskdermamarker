def execute():
    ...
    with open('content/features_images_short.p', 'rb') as pickle_file:
        ...
        headers = {
            "Authorization": "Bearer sl.BZPyyGvnGZwOGt6x2rdB13sQebZv8-Gn3NYArYdicxElZBYeS0WyPRJBDZlMBX2mIATkmUYr9C-zokHfjc2JJWkUUxLRMBsdaMVTIq-e3UNk39u4uSPcivMcMJ94ye6GeTT6bSjp",
